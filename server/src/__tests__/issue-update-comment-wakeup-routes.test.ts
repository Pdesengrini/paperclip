...
describe("issue update comment wakeups", () => {
  ...
  // COR-2890: an agent whose tool call omits its bearer lands on the
  ...
  // completed agent-owned issue — that is the infinite wake loop from COR-2877.
  ...
  // COR-2890: explicit `resume: true` remains the sanctioned reopen-and-continue
